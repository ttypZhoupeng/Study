...
let autoprefix = new LessAutoprefix({ browsers: ['last 10 versions'] });//最新的10个版本
 

//调用task(任务)api，任务名称：default是默认执行的任务，第二参数写回调
gulp.task('default',['clean','copy-html','watch','server','less','sass','stylus','compile-js'], () => console.log("ok"));
...
//监听的中枢
gulp.task('watch',['watch-html','watch-less','watch-js','watch-sass','wacth-stylus'], () => {
});
